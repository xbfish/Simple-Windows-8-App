...
using SGFoodSnap.SGFoodSnap_XamlTypeInfo;
...
namespace SGFoodSnap.SGFoodSnap_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_MainPage() { return new SGFoodSnap.MainPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "SGFoodSnap.MainPage":
                userType = new XamlUserType(this, typeName, typeof(SGFoodSnap.MainPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
